class Hand:
    ...
    def _flush(self):
        ...
        more_than_5 = [suit for suit, suit_count in self._card_suit_counts.items() if suit_count >= 5]
        return len(more_than_5) == 1
    ...
    def _straight(self):
        ...
        start_rank_index = rank_indexes[0]
        end_rank_index = start_rank_index + len(rank_indexes)
        expected = list(range(start_rank_index, end_rank_index))

        return rank_indexes == expected
